...
namespace Vive
{
    ...
    /// </example>
    public class MyVRTK_Lever : VRTK_Control
    {
            ...
            if (leverHingeJointCreated)
            {
                ...
                switch (direction)
                {
                    ...
                    case LeverDirection.z:
                        ...
                        break;
                    case LeverDirection.fx:
                        leverHingeJoint.anchor = new Vector3(0, 0, 0);
                        break;
                    case LeverDirection.fy:
                        leverHingeJoint.axis = new Vector3(0, 1, 0);
                        leverHingeJoint.anchor = new Vector3(0, 0, 0);
                        break;
                    case LeverDirection.fz:
                        leverHingeJoint.axis = new Vector3(0, 0, 1);
                        leverHingeJoint.anchor = new Vector3(0, 0, 0);
                        break;
                }
        ...
        protected virtual void InitInteractableObject()
        {
            ...
            leverInteractableObject.grabAttachMechanicScript = gameObject.AddComponent<VRTK_RotatorTrackGrabAttach>();
            leverInteractableObject.secondaryGrabActionScript = gameObject.AddComponent<VRTK_SwapControllerGrabAction>();
